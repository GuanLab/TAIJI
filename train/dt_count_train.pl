...
open REF_DATA, "/home/hyangl/2016/DC/rawdata/Drug_synergy_data/Raw_Data_csv/cell_drug_count.txt" or die; # first line of this file has minor bug
while ($line=<REF_DATA>){
	chomp $line;
	@table=split "\t", $line;
...
system "python count_save.py $the_drug";
